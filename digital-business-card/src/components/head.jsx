export default function Head() {
    return (
      <>
        <img src="\src\assets\dp.jpg" alt="A hand against window" />
            ...
            <button id="email">
              <p>
                <a href="mailto:alshiaditya55@gmail.com">
                  <img className='contact-me-icon' src='\src\assets\email-Icon.png' alt="icon representing email" />
                </a>
              </p>
              <p>Email</p>
            </button>
      ...
      <img className='contact-me-icon' src="\src\assets\linkedIn.png" alt="LinkedIn icon" />
    </a>
              </p>
              <p>LinkedIn</p>
            </button>
